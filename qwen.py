...
Если в тексте есть очевидные ошибки можешь их исправить, но не должен ничего удалять и не должен менять смысл текста.

Если после дроби встречается
"умножить на" или "разделить на",
вся дробь берётся в скобки.
